...
require_text 'id="ios-browser-override"' build/web/index.html 'iOS browser override'
require_text 'credentials:"include"' web/app.js 'same-site automatic website session credentials'
require_text '/api/rhythkit/web-session' web/app.js 'automatic Rhythians website session bootstrap'
require_text 'browser-client-id' web/app.js 'persistent browser installation identity'
require_text 'prepareAutomaticSession' web/app.js 'automatic account preparation'
...
require_text 'state_panel.rect_size=Vector2(18,18)' scripts/ui/menu/buttons/v3MapList.gd 'overlaid map status state chip'
